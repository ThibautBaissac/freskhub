...
ActiveRecord::Schema[7.1].define(version: 20_240_708_194_914) do
  ...
  create_table "billing_session_products", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[billing_product_id training_session_id],
            name: "index_billing_session_products_on_billing_product_id_and_ts_id", unique: true)
  ...
  create_table "training_session_categories", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[fresk_id identifier], name: "index_training_session_categories_on_fresk_id_and_identifier",
                                     unique: true)
  ...
  create_table "translations", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[translatable_type translatable_id], name: "index_translations_on_translatable")
  end
